...
import { ByteArray, ByteStream } from "../../framework/network/NetInterface";
import { WebSock } from "../../framework/network/WebSock";
import { GS_HeadNull_Size, S_GS_HeadNull } from "../config/NetConfig";
import { lzo1x } from "./lzo/lzo1x";
import { lzo1x_ret } from "./lzo/lzo1x_define";

//客户端与服务器的加密字段
const ENCRYPT_KEY = (() => {
    let key = ['A', 'D', 'E', 'F', 'C', 'B', 'D', 'D'];
    let ret = [];
